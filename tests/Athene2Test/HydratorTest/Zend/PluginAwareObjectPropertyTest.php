...
use Athene2\Hydrator\Zend\PluginAwareObjectProperty;
use Athene2Test\HydratorTest\Asset\AbstractPluginAwareTest;
use Athene2Test\HydratorTest\Asset\EntityAsset;

class PluginAwareObjectPropertyTest extends AbstractPluginAwareTest
{
    public function testHydrateCallsPlugin()
    {
        $pluginManager = $this->getPluginManager();
        $hydrator      = new PluginAwareObjectProperty($pluginManager);
